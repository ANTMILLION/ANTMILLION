...
public class KisApiConstant {
    ...
    public static final String WEB_SOCKET_PATH = "/oauth2/Approval";
    ...
    public static final String FOREIGNER_ORGANIZATION_PATH = "/uapi/domestic-stock/v1/quotations/investor-trend-estimate";
