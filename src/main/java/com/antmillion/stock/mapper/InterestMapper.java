...
public interface InterestMapper {
    ...
    //관심종목 삭제
    int deleteInterest(@Param("stockCode") String stockCode, @Param("accountId") String accountId);

    //특정 계정의 관심종목 조회
    List<String> selectInterestStockCodesByAccountId(@Param("accountId") String accountId);
